  ...
  return (
    <div className="sticky top-0 z-10 py-2 px-10 flex gap-2 justify-between items-center bg-white  max-sm:px-2 dark:bg-black">
      ...
      <div className="flex gap-3 border border-grey-2 px-3 py-1 items-center rounded-lg">
        <input
          className="outline-none max-sm:max-w-[120px] dark:bg-black "
          placeholder="Search... "
          value={query}
      ...
      <div className="relative flex gap-3 items-center">
        ...
        {dropdownMenu && (
          <div className="absolute top-12 right-5 flex flex-col gap-4 p-3 rounded-lg border bg-white text-base-bold lg:hidden dark:bg-zinc-800 dark:text-white">
